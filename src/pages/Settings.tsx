          ...
          <TabsContent value="security">
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {session?.mfa_verified || mfaFactors.filter(f => f.status === 'verified').length > 0 ? (
                    <div className="space-y-3">
                      ...
                      {mfaFactors.filter(f => f.status === 'verified').length === 0 && session?.mfa_verified && (
                        <div className="flex items-center justify-between p-4 bg-secondary/30 rounded-lg">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center">
                            ...
                            <div>
                              <p className="font-medium text-foreground">Email One-Time Passcode</p>
                              <p className="text-sm text-green-500">Verified for this session</p>
                            </div>
                          </div>
                        </div>
                      )}
